...
- The subagent should perform read-only analysis and return findings to the main agent.
- The main agent remains responsible for writing the final `./{output-folder}/1-techstack.md` artifact and for preserving terminology that later steps will depend on.
- This step is intended to run in parallel with step-2 subagents. Do not wait for step 2 to finish before completing this analysis.
